...
#define OS_50MS_TASK 50 // 0x0032 - P2_Server_Max
...
//Time parameters
#define P2_SERVER_MAX_HB 0x00
#define P2_SERVER_MAX_LB 0x32 // 50ms in session
#define P2_SERVER_MAX_STAR_HB 0x01
#define P2_SERVER_MAX_STAR_LB 0xF4
